...
\item \textbf{Machine-verified} [MV]: Algebraic identities, dimensions,
  embeddings, anomaly cancellation, Standard Model beta-function
  coefficients, and Goldstone boson counting.  These are properties of
  the complex Lie algebra $\so(14,\mathbb{C})$ and its representations,
  holding for all real forms including $\mathrm{SO}(3,11)$.
...
The codebase compiles as a single Lean~4 project (3,298 build jobs,
