...
R.~A.~Wilson's work on discrete order-3 elements of $E_8$ and
the $\mathrm{SU}(9)/\mathbb{Z}_3$ decomposition provided essential
mathematical foundations; correspondence with Wilson clarified the
chirality boundary.
