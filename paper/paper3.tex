...
foundation has been machine-verified in Lean~4 with the mathlib library: 46 proof files
containing over 1870 verified declarations (theorems, definitions, and lemmas) with zero \texttt{sorry} gaps.  The $\mathrm{SO}(14)$
...
mathlib library~\cite{mathlib}.  Specifically, 46 Lean~4 proof files
containing over 1870 verified declarations have been compiled with zero
...
A signature audit of all 46 proof files~\cite{uft-github}
...
Of 46 proof files containing over 1870 verified declarations: 40 files (87\%)
...
are verified across 8 Lean~4 files with zero \texttt{sorry} gaps.
The chirality question (Distler--Garibaldi vs.\ Wilson's massive
chirality) remains an open problem in mathematical physics\OP.
...
46 proof files.  One-loop renormalization group analysis yields coupling
