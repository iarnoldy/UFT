...
\item A \emph{case study} applying the protocol to Eric Dollard's versor
  algebra, producing 190 formally verified theorems across 8 Lean~4 proof files
  with zero \texttt{sorry} gaps (\Cref{sec:case-study}); the full repository
  extends to 46 proof files with over 1,870 verified declarations.
...
compile against mathlib (3,306 build jobs across the full 46-file repository,
...
(E$_8$), totaling 46 proof files with over 1,870 verified declarations---all
compiling with zero \texttt{sorry} gaps. Source code, source materials, and
analysis documents are publicly available at
\url{https://github.com/iarnoldy/UFT}.
