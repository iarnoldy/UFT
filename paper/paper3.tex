...
above the Super-Kamiokande bound of $10^{34.4}$~years), and asymptotic freedom
for all non-abelian gauge factors at scales above the Standard Model.  We state open problems honestly: the three-generation
...
experimental bounds), and asymptotic freedom for all non-abelian gauge factors.
...
The Lean~4 source code for all machine-verified proofs is publicly
available~\cite{uft-github}.
