...
foundation has been machine-verified in Lean~4 with the mathlib library: 59 proof files
containing over 2,537 verified declarations (theorems, definitions, and lemmas) with zero \texttt{sorry} gaps.  The $\mathrm{SO}(14)$
...
59 proof files containing over 2,537 verified declarations.  One-loop renormalization group analysis yields coupling
...
R.~A.~Wilson provided valuable correspondence on the chirality
question and the $\mathrm{SU}(9)/\mathbb{Z}_3$ generation mechanism.
