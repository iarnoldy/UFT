...
compile against mathlib (3,296 build jobs, zero errors, zero \texttt{sorry}
gaps). We formalize algebraic and structural claims only; we make no claims
about the physics, engineering utility, or broader validity of Dollard's work.
...
ambiguous, and unfalsifiable claims---that reveal genuine mathematical structure.
