...
a machine-checked scaffold in Lean~4 with the mathlib library: 86 proof files
...
A signature audit of 46 of the 86 proof files~\cite{uft-github}
...
are verified across 10 Lean~4 files with zero \texttt{sorry} gaps.
$E_8$ itself is now machine-verified as a Lie algebra
(248 dimensions, 7,752 nonzero brackets, Jacobi identity verified
on 3.78 billion evaluations via \texttt{native\_decide}), and
