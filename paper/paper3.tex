...
containing over 1870 theorems with zero \texttt{sorry} gaps.  The $\mathrm{SO}(14)$
...
containing over 1870 theorems have been compiled with zero
...
Of 46 proof files containing over 1870 theorems: 40 files (87\%)
...
\item \textbf{Signature audit}: classifying proofs by signature
  dependence (87\% independent, 7\% compact-only, 6\% needs-revision)
