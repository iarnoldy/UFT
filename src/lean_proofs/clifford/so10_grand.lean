...
so(10) is certified as a Lie algebra over ℝ via mathlib's typeclass system.
45 generators — the largest Lie algebra in the project with this certification. -/

instance : Sub SO10 := ⟨fun a b => add a (neg b)⟩
instance : SMul ℝ SO10 := ⟨smul⟩

@[simp] lemma sub_def' (a b : SO10) : a - b = add a (neg b) := rfl
@[simp] lemma smul_def' (r : ℝ) (a : SO10) : r • a = smul r a := rfl

instance : AddCommGroup SO10 where
...
instance : Bracket SO10 SO10 := ⟨comm⟩

@[simp] lemma bracket_def' (a b : SO10) : ⁅a, b⁆ = comm a b := rfl

set_option maxHeartbeats 16000000 in
instance : LieRing SO10 where
...
set_option maxHeartbeats 8000000 in
instance : LieAlgebra ℝ SO10 where
