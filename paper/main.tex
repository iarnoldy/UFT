...
\item A \emph{case study} applying the protocol to Eric Dollard's versor
  ...
  extends to 49 proof files with over 2,000 verified declarations, including
...
compile against mathlib (the full 49-file repository builds with
...
(E$_8$), totaling 49 proof files with over 2,000 verified declarations---all
...
Source code, source materials, and analysis documents are publicly available at
